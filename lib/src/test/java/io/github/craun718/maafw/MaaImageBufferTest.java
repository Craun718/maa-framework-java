...
class MaaImageBufferTest {
    ...
    void requireJavaArraySizeAcceptsJavaArrayLimits() {
        ...
        assertEquals(Integer.MAX_VALUE, MaaImageBuffer.requireJavaArraySize(Integer.MAX_VALUE, "raw"));
    }
    ...
    void requireJavaArraySizeRejectsOversizedBuffers() {
        ...
        assertEquals("raw is too large for a Java byte[]: " + (Integer.MAX_VALUE + 1L) + " bytes", error.getMessage());
    }
}
